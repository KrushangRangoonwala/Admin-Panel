...
import { getProductBySubCategory } from '../api/productApis';
import { getSubCategoryById, handleDeleteSubCat } from '../api/subCategoryApi';
import { getCategoryById } from '../api/categoryApis';
...
const ViewCategory = () => {
  ...
  useEffect(() => {
    if (openSub.id) {
      ...
      getProductBySubCategory(openSub.id,setProductsList);
    }
  }, [openSub])
  ...
  function handleDeleteAllSubCat() {
    ...
    setSelectedItems([]);
    getSubCategoryById(setSubcategories);
  }
