...
import { getAllSize, handleAddSize } from "../api/sizeApis";
import { getCategoryData, getDashboardData, handleDeleteCategory } from "../api/categoryApis";
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    if (expandedCategoryId) {
      getSubCategoryData(setSubcategories);
    }
  }, [expandedCategoryId]);
      ...
      <div className="dashboard-container">
        ...
        <div className="category-table-container">
          ...
          <Size
            ...
            getAllSize={() => getAllSize(setAllSize)}
